...
from numpy import asarray, random, inf, mean, zeros, sqrt
import time
...
if __name__ == '__main__':
    ...
    print 'loading...'
    size, train_x, train_y, test_x, test_y = cPickle.load(open('../../Data/mnist/lfw_liked_data.dat','rb'))
    l = train_x.shape[0]
...
#    Image.fromarray(train_x[0].reshape(-1, size)).show()
    ...
    classifier = ann(size**2 * 2, 1, [200, 10, 5])
