...
#                print self.ann_str.layers[-1].W.get_value()
                ...
                if (iter + 1) % validation_frequency == 0:
                    ...
                    if (this_validation_loss < best_validation_loss and not reverse) or \
                        (this_validation_loss > best_validation_loss and reverse):
...
if __name__ == '__main__':
    ...
    #training 
    #classifier = ann(size**2, 10, [30, 25, 20], n_epochs = 1000, learning_rate = 0.01)
    classifier = ann(size**2, 10, [], n_epochs = 200, learning_rate = 0.01)
    classifier.fit(datasets, batch_size = 20)
