...
def evaluate_lenet5(learning_rate=0.1, n_epochs=200,
    ...
    print 'loading...'
    train_x, train_y, test_x, test_y = cPickle.load(open('../data.dat','rb')) 
    ...
    #Image.fromarray(train_x[0][:size**2].reshape(size, -1)).show()
    ...
    batch_size = 1000
    layer0_input = x.reshape((batch_size, 1, l, l))
